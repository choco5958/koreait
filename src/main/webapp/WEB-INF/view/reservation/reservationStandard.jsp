...
<div class="title" align="center"><hr class="hr"><br>스탠다드 예약</div>
<div class="item1">	
	<div class="item1_1">	
		...
		<div class="item1_2">
			...
			<input type="text" name="checkIn" class="input" id="datepicker1" placeholder="예약 시작일"><br>
		 	...
		 	<input type="text" class="input" placeholder="객실 타입 : 스탠다드" readonly><br>
		 	<input type="text" class="input" placeholder="객실 가격 : 100,000원" readonly>
		</div>
		</div>		
		<div class="item3">
