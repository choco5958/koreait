...
<script type="text/javascript">
	function goPost() {
		...
		formInput(form, "roomType", "디럭스");
		formInput(form, "ruserPrice", "200000");
		formInput(form, "roomGrade", "2");
...
<div class="title" align="center"><hr class="hr"><br>디럭스 예약</div>
<div class="item1">	
	<div class="item1_1">	
		...
		<div class="item1_2">
			...
			<input type="text" name="checkIn" class="input" id="datepicker1" placeholder="예약 시작일"><br>
		 	...
		 	<input type="text" class="input" placeholder="객실 타입 : 디럭스" readonly><br>
		 	<input type="text" class="input" placeholder="객실 가격 : 200,000원" readonly>
		</div>
		</div>		
		<div class="item3">
