...
<script type="text/javascript">
	function goPost() {
		...
		formInput(form, "roomType", "스위트");
		formInput(form, "ruserPrice", "500000");
		formInput(form, "roomGrade", "3");
...
<div class="title" align="center"><hr class="hr"><br>스위트 예약</div>
<div class="item1">	
	<div class="item1_1">	
		...
		<div class="item1_2">
			...
			<input type="text" name="checkIn" class="input" id="datepicker1" placeholder="예약 시작일"><br>
		 	...
		 	<input type="text" class="input" placeholder="객실 타입 : 스위트" readonly><br>
		 	<input type="text" class="input" placeholder="객실 가격 : 500,000원" readonly>
		</div>
		</div>		
		<div class="item3">
