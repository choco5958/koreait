...
<head>
<meta charset="UTF-8">
<title>Hotel Delluna | Room - Prestige</title>
<meta charset="utf-8">
...
<body class="stretched">
	<section id="page-title" class="page-title-parallax"
		...
		<div class="container clearfix">
			<font size="6" color="white">The White Hotel | Prestige Room</font>
		</div>
	</section>
			...
			<div class="container clearfix">
				<div class="nobottommargin clearfix">
					<div class="nobottommargin">
						<div class="clearfix">
							<p></p>
							<h2 style="margin-top: 30px; margin-bottom: 30px;">프레스티지 룸(Prestige Room) 
							...
							<p></p>
							<p>
								<a href="/TeamProject/reservation/reservationPrestige" class="btn btn-primary" role="button">예약하기</a>
								...
								<div class="carousel-inner">
									...
									<div class="carousel-item active">
										...
										<img class="d-block w-100"
											src="${pageContext.request.contextPath}/resources/image/1001.jpg"
											alt="First slide">
									...
									<div class="carousel-item">
										<img class="d-block w-100"
											src="${pageContext.request.contextPath}/resources/image/1002.jpg"
											alt="Second slide">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100"
											src="${pageContext.request.contextPath}/resources/image/1003.jpg"
											alt="Third slide">
									</div>
									<!-- / 슬라이드 쇼 끝 -->
									<!-- 왼쪽 오른쪽 화살표 버튼 -->
							...
							<p>
                                    ...
                                    &middot; 아이들을 위한 장난감, 컴퓨터 제공<br>
                                    &middot; 맞춤형 베개 제공<br>
                                    &middot; 요청 시 한실 베개,젠 메밀 베개,바이오 베개,메모리폼 베개,양모 베개 제공<br>
                                    &middot; 전 객실 초고속 무료 인터넷 (유선, 와이파이)
									<hr style="border: solid 1px navy;">
                              		<h3>어메니티</h3><p> 
                                    일반 : 60" LCD TV / 발코니 / 손전등 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 욕실 : 욕실용품(몰튼브라운) / 비데 / 면도기 / 목욕 가운 / 헤어드라이어<br>
	...
	<div class="div1">
		<div class="div2">
			<form action="PrestigeRoom" method="post" name="fr" onsubmit="return check()">
				<div class="div3">
					...
					<input type="hidden" name="Prestige" value="Prestige">
				</div>
			</form>
