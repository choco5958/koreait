...
<head>
<meta charset="UTF-8">
<title>Hotel Delluna | Room - Deluxe</title>
<meta charset="utf-8">
...
<body class="stretched">
	<section id="page-title" class="page-title-parallax"
		...
		<div class="container clearfix">
			<font size="6" color="white">The White Hotel | Deluxe Room</font>
		</div>
	</section>
			...
			<div class="container clearfix">
				<div class="nobottommargin clearfix">
					<div class="nobottommargin">
						<div class="clearfix">
							<p></p>
							<h2 style="margin-top: 30px; margin-bottom: 30px;">디럭스(Deluxe) 
							...
							<p></p>
							<p>
								<a href="/TeamProject/reservation/reservationDeluxe" class="btn btn-primary" role="button">예약하기</a>
								...
								<div class="carousel-inner">
									...
									<div class="carousel-item active">
										...
										<img class="d-block w-100"
											src="${pageContext.request.contextPath}/resources/image/201.jpg"
											alt="First slide">
									...
									<div class="carousel-item">
										<img class="d-block w-100"
											src="${pageContext.request.contextPath}/resources/image/202.jpg"
											alt="Second slide">
									</div>
									<div class="carousel-item">
										<img class="d-block w-100"
											src="${pageContext.request.contextPath}/resources/image/203.jpg"
											alt="Third slide">
									</div>
									<!-- / 슬라이드 쇼 끝 -->
									<!-- 왼쪽 오른쪽 화살표 버튼 -->
							...
							<p>
							<h3 style="margin-top: 60px;">객실개요</h3>
							<p>
							...
							<p>
								&middot; Spa & Garden 해온: 사계절 야외수영장 및 자쿠지, 사우나<br> &middot;
								해온(he:on) 베딩 시스템: 최상의 숙면을 위한 침대 및 침구류<br> &middot; 전 객실 초고속
								무료 인터넷 (유선, 와이파이)
							<hr style="border: solid 1px navy;">
							<h3>어메니티</h3>
							<p>
	...
	<div class="div1">
		<div class="div2">
			<form action="DeluxeRoom" method="post" name="fr" onsubmit="return check()">
				<div class="div3">
					...
					<input type="hidden" name="Deluxe" value="Deluxe">
				</div>
			</form>
