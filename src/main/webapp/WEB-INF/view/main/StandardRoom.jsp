...
<head>
<meta charset="UTF-8">
<title>Hotel Delluna | Room - Standard</title>
<meta charset="utf-8">
...
<body class="stretched">
	<section id="page-title" class="page-title-parallax"
		...
		<div class="container clearfix">
			<font size="6" color="white">The White Hotel | Standard Room</font>
		</div>
	</section>
			...
			<div class="container clearfix">
				<div class="nobottommargin clearfix">
					<div class="nobottommargin">
						<div class="clearfix">
							<p></p>
							<h2 style="margin-top: 30px; margin-bottom: 30px;">스탠다드 룸(Standard Room) 
							...
							<p></p>
							<p>
								<a href="/TeamProject/reservation/reservationStandard" class="btn btn-primary" role="button">예약하기</a>
								...
								<div class="carousel-inner">
									...
									<div class="carousel-item active">
										...
										<img class="d-block w-100"
											src="${pageContext.request.contextPath}/resources/image/101.jpg"
											alt="First slide">
									...
									<div class="carousel-item">
										<img class="d-block w-100"
											src="${pageContext.request.contextPath}/resources/image/102.jpg"
											alt="Second slide">
									</div>
									<!-- / 슬라이드 쇼 끝 -->
									<!-- 왼쪽 오른쪽 화살표 버튼 -->
	...
	<div class="div1">
		<div class="div2">
			<form action="StandardRoom" method="post" name="fr" onsubmit="return check()">
				<div class="div3">
